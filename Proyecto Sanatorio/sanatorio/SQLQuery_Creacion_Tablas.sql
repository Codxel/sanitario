...
CREATE TABLE [dbo].[Medico_Hospital_Servicio](
    ...
    CONSTRAINT [FK_Hospital] FOREIGN KEY ([Id_Hospital]) REFERENCES [dbo].[Hospital] ([Id_Hospital]),
    CONSTRAINT [FK_Servicio] FOREIGN KEY ([Id_Servicio]) REFERENCES [dbo].[Servicio] ([Id_Servicio]),
